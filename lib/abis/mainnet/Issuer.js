export default [
  ...
  },
  {
    ...
    outputs: [{ internalType: 'bool', name: 'rateInvalid', type: 'bool' }],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
  },
  ...
  },
  {
    ...
    inputs: [
      { internalType: 'address', name: 'account', type: 'address' },
      { internalType: 'bool', name: 'isSelfLiquidation', type: 'bool' },
    ],
    ...
    outputs: [
      ...
      { internalType: 'uint256', name: 'debtRemoved', type: 'uint256' },
      {
        internalType: 'uint256',
  ...
  {
    constant: false,
    inputs: [{ internalType: 'uint128', name: 'periodId', type: 'uint128' }],
  ...
  },
  {
    constant: false,
    inputs: [
      { internalType: 'address', name: 'short', type: 'address' },
      { internalType: 'uint256', name: 'amount', type: 'uint256' },
    ],
