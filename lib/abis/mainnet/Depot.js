export default [
  ...
  {
    constant: false,
    inputs: [{ name: 'synthAmount', type: 'uint256' }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'newSynthetixPrice', type: 'uint256' },
  ...
  {
    constant: false,
    inputs: [{ name: 'synthAmount', type: 'uint256' }, { name: 'guaranteedRate', type: 'uint256' }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'guaranteedSynthetixRate', type: 'uint256' },
    ],
  ...
  {
    constant: false,
    inputs: [{ name: '_snxProxy', type: 'address' }],
    name: 'setSynthetix',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, name: 'newSNXProxy', type: 'address' }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, name: 'newSynthetixPrice', type: 'uint256' },
