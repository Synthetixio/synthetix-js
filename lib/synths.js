const MAINNET_SYNTHS = [
  ...
  },
  {
    ...
    index: [
      ...
      { asset: 'AAVE', units: 8.41, weight: 15 },
      {
        asset: 'UMA',
        category: 'crypto',
        sign: '',
      ...
      { asset: 'UNI', units: 92.09, weight: 10 },
      {
        asset: 'KNC',
        category: 'crypto',
        sign: '',
      ...
      { asset: 'CRV', units: 253.8, weight: 5 },
      { asset: 'WNXM', units: 4.53, weight: 5 },
      { asset: 'YFI', units: 0.023, weight: 15 },
      {
        asset: 'BAL',
        category: 'crypto',
        sign: '',
