export default [
  ...
  {
    constant: true,
    inputs: [{ name: '_claimingAddress', type: 'address' }],
  ...
  },
  {
    constant: false,
    inputs: [
      { name: 'claimingForAddress', type: 'address' },
      { name: 'currencyKey', type: 'bytes4' },
    ],
    name: 'claimOnBehalf',
  ...
  {
    constant: false,
    inputs: [{ name: '_delegates', type: 'address' }],
  ...
  },
  {
    inputs: [
      ...
      { name: '_feePoolEternalStorage', type: 'address' },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, name: 'newDelegateApprovals', type: 'address' }],
    name: 'DelegateApprovalsUpdated',
    type: 'event',
    signature: '0x2d7301bdaa2632e140c1efeab3ea03a4301ac483eabfb54d7979fa3f715eec3f',
  },
  {
    anonymous: false,
