export default [
  ...
  {
    constant: true,
    inputs: [{ name: 'currencyKeys', type: 'bytes4[]' }],
    name: 'anyRateIsStale',
    outputs: [{ name: '', type: 'bool' }],
    payable: false,
    stateMutability: 'view',
  ...
  {
    constant: false,
    inputs: [{ name: '_priceUpdateLock', type: 'bool' }],
  ...
  },
  {
    inputs: [
      ...
      { name: '_currencyKeys', type: 'bytes4[]' },
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, name: 'currencyKeys', type: 'bytes4[]' },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, name: 'currencyKey', type: 'bytes4' }],
    name: 'RateDeleted',
    type: 'event',
