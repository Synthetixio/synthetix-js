export default [
  ...
  },
  {
    ...
    name: 'accessControl',
    outputs: [{ name: 'canSuspend', type: 'bool' }, { name: 'canResume', type: 'bool' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  ...
  },
  {
    ...
    outputs: [{ name: 'suspended', type: 'bool' }, { name: 'reason', type: 'uint248' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  ...
  },
  {
    constant: false,
    inputs: [
      { name: 'section', type: 'bytes32' },
      { name: 'account', type: 'address' },
      { name: 'canSuspend', type: 'bool' },
      { name: 'canResume', type: 'bool' },
    ],
  ...
  {
    constant: false,
    inputs: [{ name: 'currencyKey', type: 'bytes32' }, { name: 'reason', type: 'uint256' }],
    name: 'suspendSynth',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  {
    constant: true,
    inputs: [{ name: 'synths', type: 'bytes32[]' }],
    name: 'getSynthSuspensions',
    outputs: [{ name: 'suspensions', type: 'bool[]' }, { name: 'reasons', type: 'uint256[]' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, name: 'reason', type: 'uint256' }],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, name: 'section', type: 'bytes32' },
      { indexed: true, name: 'account', type: 'address' },
      { indexed: false, name: 'canSuspend', type: 'bool' },
      { indexed: false, name: 'canResume', type: 'bool' },
    ],
