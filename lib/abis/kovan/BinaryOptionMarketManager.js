export default [
  {
    inputs: [
      ...
      { internalType: 'uint256', name: '_refundFee', type: 'uint256' },
    ],
    payable: false,
  ...
  },
  {
    ...
    inputs: [
      ...
      { internalType: 'bool', name: 'refundsEnabled', type: 'bool' },
      { internalType: 'uint256[2]', name: 'times', type: 'uint256[2]' },
      { internalType: 'uint256[2]', name: 'bids', type: 'uint256[2]' },
    ],
    name: 'createMarket',
    outputs: [
      {
  ...
  {
    constant: false,
    inputs: [{ internalType: 'uint256', name: '_poolFee', type: 'uint256' }],
    name: 'setPoolFee',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  {
    constant: false,
    inputs: [{ internalType: 'uint256', name: '_refundFee', type: 'uint256' }],
    name: 'setRefundFee',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
