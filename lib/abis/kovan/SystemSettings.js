export default [
  ...
  },
  {
    constant: true,
    inputs: [],
    name: 'MAX_ETHER_WRAPPER_BURN_FEE_RATE',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
    signature: '0x6022aac5',
  },
  {
    constant: true,
    inputs: [],
    name: 'MAX_ETHER_WRAPPER_MINT_FEE_RATE',
    outputs: [{ internalType: 'uint256', name: '', type: 'uint256' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
    signature: '0xdafd2daf',
  },
  {
    constant: true,
    inputs: [],
