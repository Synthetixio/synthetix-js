export default [
  ...
  },
  {
    ...
    stateMutability: 'view',
    type: 'function',
    signature: '0x82fc0f02',
  },
  {
    constant: true,
    inputs: [{ name: 'issuer', type: 'address' }, { name: 'currencyKey', type: 'bytes32' }],
    name: 'remainingIssuableSynths',
    outputs: [{ name: '', type: 'uint256' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
    signature: '0x8357ce36',
  },
  {
    constant: true,
