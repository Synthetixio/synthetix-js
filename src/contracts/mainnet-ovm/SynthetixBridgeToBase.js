...
import abi from '../../../lib/abis/mainnet-ovm/SynthetixBridgeToBase';

/** @constructor
 * @param contractSettings {ContractSettings}
 */
function SynthetixBridgeToBase(contractSettings) {
  this.contractSettings = contractSettings || new ContractSettings();

  this.contract = new Contract(
    this.contractSettings.addressList['SynthetixBridgeToBase'],
    abi,
...
export default SynthetixBridgeToBase;
