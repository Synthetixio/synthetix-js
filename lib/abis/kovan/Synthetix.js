export default [
  ...
  {
    constant: false,
    inputs: [{ name: 'burnForAddress', type: 'address' }],
  ...
  {
    constant: false,
    inputs: [{ name: 'issueForAddress', type: 'address' }],
  ...
  {
    constant: true,
    inputs: [{ name: '_issuer', type: 'address' }, { name: 'currencyKey', type: 'bytes32' }],
    name: 'debtBalanceOfAndTotalDebt',
    outputs: [
      { name: 'debtBalance', type: 'uint256' },
      { name: 'totalSystemValue', type: 'uint256' },
    ],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  ...
  },
  {
    ...
    outputs: [
      ...
      { name: 'numEntriesSettled', type: 'uint256' },
    ],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  {
    constant: false,
    inputs: [{ name: 'burnForAddress', type: 'address' }, { name: 'amount', type: 'uint256' }],
  ...
  },
  {
    constant: false,
    inputs: [
      { name: 'exchangeForAddress', type: 'address' },
  ...
  {
    constant: false,
    inputs: [{ name: 'issueForAddress', type: 'address' }, { name: 'amount', type: 'uint256' }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, name: 'fromCurrencyKey', type: 'bytes32' },
      { indexed: false, name: 'fromAmount', type: 'uint256' },
      { indexed: false, name: 'toCurrencyKey', type: 'bytes32' },
