export default [
  ...
  {
    constant: false,
    inputs: [{ name: '_rewardsAuthority', type: 'address' }],
  ...
  },
  {
    ...
    name: 'feesByPeriod',
    outputs: [{ name: 'results', type: 'uint256[2][3]' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  ...
  {
    constant: false,
    inputs: [{ name: 'account', type: 'address' }, { name: 'quantity', type: 'uint256' }],
  ...
  },
  {
    inputs: [
      ...
      { name: '_rewardsAuthority', type: 'address' },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, name: 'snxRewards', type: 'uint256' },
    ],
    name: 'FeesClaimed',
    type: 'event',
