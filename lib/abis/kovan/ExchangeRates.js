export default [
  ...
  {
    constant: true,
    inputs: [{ name: 'currencyKeys', type: 'bytes32[]' }],
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'startingRoundId', type: 'uint256' },
      { name: 'startingTimestamp', type: 'uint256' },
      { name: 'timediff', type: 'uint256' },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'roundIdForSrc', type: 'uint256' },
      { name: 'roundIdForDest', type: 'uint256' },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: 'freezeAtUpperLimit', type: 'bool' },
    ],
  ...
  },
  {
    constant: false,
    inputs: [
      { name: 'currencyKeys', type: 'bytes32[]' },
      { name: 'newRates', type: 'uint256[]' },
  ...
  {
    constant: true,
    inputs: [{ name: 'currencyKey', type: 'bytes32' }, { name: 'roundId', type: 'uint256' }],
    name: 'rateAndTimestampAtRound',
    outputs: [{ name: 'rate', type: 'uint256' }, { name: 'time', type: 'uint256' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  ...
  },
  {
    inputs: [
      ...
      { name: '_currencyKeys', type: 'bytes32[]' },
      { name: '_newRates', type: 'uint256[]' },
    ],
    payable: false,
    stateMutability: 'nonpayable',
    type: 'constructor',
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, name: 'rateStalePeriod', type: 'uint256' }],
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, name: 'currencyKeys', type: 'bytes32[]' },
      { indexed: false, name: 'newRates', type: 'uint256[]' },
    ],
    name: 'RatesUpdated',
    type: 'event',
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, name: 'currencyKey', type: 'bytes32' }],
    name: 'RateDeleted',
    type: 'event',
  ...
  },
  {
    anonymous: false,
    inputs: [
      { indexed: false, name: 'currencyKey', type: 'bytes32' },
      { indexed: false, name: 'entryPoint', type: 'uint256' },
      { indexed: false, name: 'upperLimit', type: 'uint256' },
      { indexed: false, name: 'lowerLimit', type: 'uint256' },
    ],
  ...
  },
  {
    ...
    inputs: [
      { indexed: false, name: 'currencyKey', type: 'bytes32' },
      { indexed: false, name: 'aggregator', type: 'address' },
    ],
