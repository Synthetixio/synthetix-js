export default [
  ...
  },
  {
    constant: true,
    inputs: [{ internalType: 'address', name: 'account', type: 'address' }],
    name: 'canConfirmOrder',
    outputs: [{ internalType: 'bool', name: '', type: 'bool' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
    signature: '0xffc97ea5',
  },
  {
    constant: true,
    inputs: [{ internalType: 'address', name: 'account', type: 'address' }],
  ...
  },
  {
    ...
    name: 'parameters',
    outputs: [
      { internalType: 'uint256', name: 'exchangeFee', type: 'uint256' },
  ...
  {
    constant: false,
    inputs: [{ internalType: 'uint256', name: 'exchangeFee', type: 'uint256' }],
    name: 'setExchangeFee',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  {
    constant: false,
    inputs: [{ internalType: 'uint256', name: 'maxLeverage', type: 'uint256' }],
    name: 'setMaxLeverage',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
