export default [
  ...
  {
    constant: true,
    inputs: [{ name: '_account', type: 'address' }, { name: '_loanID', type: 'uint256' }],
  ...
  {
    constant: false,
    inputs: [{ name: '_issueLimit', type: 'uint256' }],
    name: 'setIssueLimit',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  {
    constant: false,
    inputs: [{ name: '_minLoanSize', type: 'uint256' }],
    name: 'setMinLoanSize',
    outputs: [],
    payable: false,
    stateMutability: 'nonpayable',
  ...
  {
    constant: false,
    inputs: [{ name: '_loanLimit', type: 'uint256' }],
  ...
  },
  {
    ...
    outputs: [
      { name: '_collateralizationRatio', type: 'uint256' },
      { name: '_issuanceRatio', type: 'uint256' },
      { name: '_interestRate', type: 'uint256' },
      { name: '_interestPerSecond', type: 'uint256' },
      { name: '_issueFeeRate', type: 'uint256' },
      { name: '_issueLimit', type: 'uint256' },
      { name: '_minLoanSize', type: 'uint256' },
      { name: '_totalIssuedSynths', type: 'uint256' },
      { name: '_totalLoansCreated', type: 'uint256' },
      { name: '_totalOpenLoanCount', type: 'uint256' },
      { name: '_ethBalance', type: 'uint256' },
      { name: '_liquidationDeadline', type: 'uint256' },
      { name: '_loanLiquidationOpen', type: 'bool' },
    ],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  ...
  },
  {
    ...
    inputs: [{ name: '_account', type: 'address' }, { name: '_loanID', type: 'uint256' }],
    name: 'loanLifeSpan',
    outputs: [{ name: 'loanLifeSpan', type: 'uint256' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  ...
  {
    constant: true,
    inputs: [{ name: '_loanAmount', type: 'uint256' }, { name: '_seconds', type: 'uint256' }],
    name: 'accruedInterestOnLoan',
    outputs: [{ name: 'interestAmount', type: 'uint256' }],
    payable: false,
    stateMutability: 'view',
    type: 'function',
  ...
  {
    constant: false,
    inputs: [{ name: '_issueFeeRate', type: 'uint256' }],
  ...
  {
    constant: false,
    inputs: [{ name: '_loanLiquidationOpen', type: 'bool' }],
  ...
  },
  {
    constant: false,
    inputs: [
      { name: '_loanCreatorsAddress', type: 'address' },
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, name: 'interestRate', type: 'uint256' }],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, name: 'issueFeeRate', type: 'uint256' }],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, name: 'issueLimit', type: 'uint256' }],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, name: 'minLoanSize', type: 'uint256' }],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, name: 'loanLimit', type: 'uint256' }],
  ...
  {
    anonymous: false,
    inputs: [{ indexed: false, name: 'loanLiquidationOpen', type: 'bool' }],
